...
export function Home1()
{
    ...
    const {likePosts,checkLikes,unLikePosts,addBookmark,checkBookMarks,removeBookmark,newPost}=useContext(PostsContext)
        ...
        <section className="home">
            ...
            <div className="home_postsSection">
                <div className="home_postsSection-newPost">
                    ...
                    <input onChange={(e)=>postDetails.path=e.target.files[0]} type="file"></input>
