...
function sendEditPost()
{
    ...
    return(<div>
        <section className="home">
            <RouteSec></RouteSec>
            <div style={{display:show?"block":"none"}} className="editSectionPost">
            ...
            <div className="home_postsSection">
                <div className="home_postsSection-newPost">
                    <textarea  onChange={(e)=>postDetails.content=e.target.value}></textarea>
                    <label>Choose Image<input className="editSection__details-input" onChange={(e)=>postDetails.img=e.target.files[0]} type="file"></input>
                    </label>
