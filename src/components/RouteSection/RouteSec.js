...
export function RouteSec()
{
    ...
    return (<div>
        ...
        <div className="RouteSec_pages">
                ...
                <NavLink className="RouteSec_pages-navLinks" onClick={()=>intialBookMarks()}><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#fa005a" stroke-width="2" stroke-linecap="square" stroke-linejoin="round"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path></svg>Bookmark</NavLink>
